...
const BillPdf = (prop) => {
    ...
    const sem_superscript =
        { sem_no } == 1 ? 'st' : sem_no == 2 ? 'nd' : sem_no == 3 ? 'rd' : 'th';
    ...
    return (
        <div className="w-full border border-slate-900 h-full">
            <PDFViewer className="w-full min-h-full">
                <Document
                    title={`${sem_no}${sem_superscript} Semester Bill Form of ${evaluator.evaluator_english_name}`}
                    fileName="bill-form.pdf"
                >
                    <Page
                    ...
                    >
                        <View style={[styles.topPart, { marginBottom: '0px' }]}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    {' '.repeat(
                                        13 -
                                            evaluator.evaluator_id.toString()
                                                .length
                                    )}{' '}
                                </Text>
                            </View>
                                        ...
                                        <View style={styles.tableRow}>
                                            ...
                                            >
                                                <Text style={styles.tableCell}>
                                                    {matchedBill &&
                                                    matchedBill[
                                                        'খাতা/ছাত্রের সংখ্যা/পৃষ্ঠার সংখ্যা'
                                                    ]
                                                        ? matchedBill[
                                                              'খাতা/ছাত্রের সংখ্যা/পৃষ্ঠার সংখ্যা'
                                                          ]
                        ...
                        <View style={styles.bottomPart}>
                            ...
                            >
                                <Text>
                                    পরীক্ষার পারিতোষিক বিল প্রাপ্তি স্বীকার{' '}
                                </Text>
                            </View>
                            <View>
                                <Text style={styles.writing}>
