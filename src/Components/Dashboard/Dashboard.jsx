...
const Dashboard = (prop) => {
    ...
    const menus = [
        {
            ...
            activity: [
                ...
                {
                    menuText: 'Exam committee info',
                    route: 'form-exam-committee',
                },
                {
                    menuText: 'Manage activity bill',
                    route: 'fill-activity-bill',
                },
            ],
        },
        {
    ...
    const Cactivity = menus.filter(
        (menu) =>
            menu.person.toLowerCase() === sessionStorage.role.toLowerCase()
    );
