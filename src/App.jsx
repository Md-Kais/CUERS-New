                        ...
                        <Routes>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Route
                                        element={
                                            <CourseInSemesterExam></CourseInSemesterExam>
                                        }
                                        path="course-in-semester-exam"
                                    ></Route>
                                    <Route
                                        element={
                                            <ManageSemesterActivity></ManageSemesterActivity>
                                        }
                                        path="manage-semester-activity"
                                    ></Route>
                                    <Route
                                        element={
                                            <ManageEditRequests></ManageEditRequests>
                                        }
                                        path="manage-edit-requests"
                                    ></Route>
                                    <Route
                                        element={
                                            <GenerateActivityPDF></GenerateActivityPDF>
                                        }
                                ...
                                >
                                    ...
                                    ></Route>
                                    <Route
                                        element={<BillTrack></BillTrack>}
                                        path="track-bill-form"
                                    ></Route>
                                </Route>
                            </Route>
